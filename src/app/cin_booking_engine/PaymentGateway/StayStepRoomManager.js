...
const StayStepRoomManager = () => {
  const { selectedRooms, setSelectedRooms, selectedRoom, setSelectedRoom, setRoomsChange, isRoomsChange } = useBookingEngineContext();
            ...
            <div className="row">
              ...
              <div className="roomsDropdown" id="roomsDropdown">
                <div className="card card-body" ref={containerRef}>
                  ...
                  <button className="btn btn-link add-room" onClick={addRoom} disabled={rooms.length >= 10}>
                    + Add Another Room
                  </button>
                </div>
