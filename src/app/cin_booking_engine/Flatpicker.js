...
const DateRangePicker = () => {
  const { setSelectedDates,
    selectedStartDate,
    selectedEndDate,
    selectedPropertyId } = useBookingEngineContext();
  ...
  useEffect(() => {
    const fetchPrices = async () => {
      ...
      try {
        ...
        const signature = await createSignature(JSON.stringify(selectedPropertyId), timestamp, secret);
        ...
        const response = await fetch("https://cinbe.cinuniverse.com/api/cin-api/rate-et", {
          method: "POST",
          headers: {
