...
export default function HotelOverviewClient({
  hotelData,
  brand_slug,
  hotel_slug,
}) {
  ...
  // console.log("hotel_offers",offers1)
  ...
  return (
    <>
      ...
      <section className="banner-section">
        {bannerSlider && bannerSlider.length > 0 && bannerSlider[0] && (
          <div
      ...
      <section className="your-break about-us sec-padding">
        <div className="container">
            ...
            {hotelList &&
              ...
              hotelList.map((val, index) => (
                <div className="container gurgaon-hotel" key={index}>
                  ...
                  <h1
                    id="gurgaon-hotel"
                    className="global-heading-gurgaon sub-head"
                  >
                    {val.sub_title}
                  </h1>
                  ...
                  <div className="content-boxx hotel_rd_more">
                    <div className="content-boxx hotel_rd_more">
                      <div
                        dangerouslySetInnerHTML={{ __html: val.short_desc }}
                      ></div>

                      {isExpanded && (
                        <GurgaonHotelExtended
                          homeDescription={val.home_description}
                        />
                      )}
          ...
          <section className="your-break mtn12 sec-padding mt-5">
            <motion.section
              className="our-offers about-us alivaa-new-offers-see"
            ...
            >
              <div className="container">
                {hotelList && hotelList.length > 0 && (
                  <h4 className="global-heading-gurgaon inner-hd text-center">
                    {hotelList[0].offers_heading}
                  </h4>
                )}
                              ...
                              {offers1.map((offer, index) => (
                                <SwiperSlide key={index}>
                                  <img
                                    ...
                                    alt={offer.title}
                                    className="img-fluid img2 w-100"
                                  />
                                  <div className="text-center">
                                    ...
                                    <Link
                                      href={`/${
                                        offer.landing_page_link || "#"
                                      }`}
                                      className="btn btn-primary voffset-2 cls-intro-offer"
                                    >
                                      View Offer
                                    </Link>
                                  </div>
          ...
          <motion.section
            className="rooms-info-block gurgaon-hotel-facilities mt-0 pt-0"
          ...
          <motion.section
            className="gallery-section mb-tst gurgaon-hotel-testimonials"
          ...
          >
            <article className="container mb-5">
              <div
                className="col-lg-12 text-center wow fadeInDown animated mb-5"
                data-wow-duration="4s"
                style={{
                  visibility: "visible",
                  WebkitAnimationDuration: "4s",
    ...
    {hotelList && hotelList.length > 0 && (
                ...
                <h4
                  className="global-heading-gurgaon inner-hd text-center"
                  style={{ color: "#4a4a4a" }}
                >
                  Testimonials
                </h4>
